...
const AllBlog = () => {
  const seoData = {
    ...
    description:
      "Explore our comprehensive collection of articles about biodata creation, marriage profiles, and traditional matrimonial practices. Expert tips and professional guides.",
    keywords:
      "biodata blog, marriage profile tips, biodata creation guide, matrimonial advice, traditional biodata tips",
    ...
    schema: {
      ...
      description:
        "Professional guides and tips for creating perfect marriage biodata",
      publisher: {
        "@type": "Organization",
