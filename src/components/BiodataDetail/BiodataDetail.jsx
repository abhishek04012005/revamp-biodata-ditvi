...
const BiodataDetail = () => {
  ...
  const [selectedModel, setSelectedModel] = useState(
    biodataDetails?.find((biodata) => biodata.modelName === modelName)
      ?.modelNumber || ""
  );
    ...
    return (
      biodata?.[
        selectedLanguage === Languages.English.Name
          ? selectedType === ModelTypes.Professional.Name
            ? "image"
            : "studentImage"
          : selectedType === ModelTypes.Professional.Name
          ? "hindiImage"
                    ...
                    <div className="radio-group">
                      ...
                      >
                        <input
                          ...
                          onChange={() =>
                            handleLanguageChange(Languages.English.Name)
                          }
                        />
                      ...
                      <label
                        className={`variant-option ${
                          selectedLanguage === Languages.Hindi.Name
                            ? "active"
                            : ""
                        }`}
                      >
                        <input
                          ...
                          onChange={() =>
                            handleLanguageChange(Languages.Hindi.Name)
                          }
                        />
                    ...
                    <div className="radio-group">
                      ...
                      >
                        <input
                          ...
                          onChange={() =>
                            handleTypeChange(ModelTypes.Professional.Name)
                          }
                        />
                      ...
                      <label
                        className={`variant-option ${
                          selectedType === ModelTypes.Student.Name
                            ? "active"
                            : ""
                        }`}
                      >
                        <input
                          ...
                          onChange={() =>
                            handleTypeChange(ModelTypes.Student.Name)
                          }
                        />
