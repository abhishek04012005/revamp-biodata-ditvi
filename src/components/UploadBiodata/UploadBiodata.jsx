...
const UploadBiodata = () => {
    ...
    const steps = [
        ...
        {
            title: 'Review & Submit',
            isComplete: !!imageFile && !!biodataFile
        }
    ];
    ...
    return (
        <section className="upload-files">
            <Container>
                <HeaderSection title={`Upload Biodata`} subtitle={`Upload Your Profile Photo and Existing Biodata.`} />
                <div className="upload-files-content">
                    ...
                    <div className="upload-section" style={{ display: currentStep === 1 ? 'block' : 'none' }}>
                            ...
                            >
                                {imagePreview ? (
                                    ...
                                    <>
                                        ...
                                        <span className="file-hint">JPG, PNG or JPEG (Max 1MB)</span>
                                    </>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="upload-section" style={{ display: currentStep === 2 ? 'block' : 'none' }}>
                        <div className="upload-box">
                            <input
                                type="file"
                                ref={biodataInputRef}
                            ...
                            >
                                {biodataFile ? (
                                    <div className="file-success">
                                        {biodataPreview ? (
                                            <div className="preview-container">
                                                <img src={biodataPreview} alt="Biodata" className="image-preview" />
                                                <div className="preview-overlay">
                                                    <Check className="success-icon" />
                                                    <p>Click to change</p>
                                                </div>
                                    ...
                                    <>
                                        ...
                                        <button className='upload-photo-btn'>Upload Biodata</button>
                                        <p>Click to upload your existing biodata</p>
                                        <span className="file-hint">PDF, DOC, or Image files (Max 5MB)</span>
                                    </>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="upload-section" style={{ display: currentStep === 3 ? 'block' : 'none' }}>
                        <div className="review-section">
                            <div className="review-item">
                                <h4>Profile Photo</h4>
                                {imagePreview && (
                                    <img src={imagePreview} alt="Profile" className="review-image" />
                                )}
                            </div>
                            <div className="review-item">
                                <h4>Biodata</h4>
                                {biodataPreview ? (
                                    <img src={biodataPreview} alt="Biodata" className="review-image" />
                                ) : (
