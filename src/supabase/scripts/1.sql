...
CREATE TABLE public.admim_login_details (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
INSERT INTO "public"."admim_login_details" ("id", "user_name", "password", "name", "is_active", "created_at") VALUES ('963b8f3c-f7de-426b-8953-89e7e94a49c4', 'admin', 'Admin@3112', 'Super Admin', 'true', '2025-05-17 06:44:51.465523+00');
